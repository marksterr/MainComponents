...
//            Toast.makeText(this, "Success!", Toast.LENGTH_SHORT).show()
    ...
    private fun updateListView(contacts: List<Contact>) {
        val listView: ListView = findViewById(R.id.lvContacts)
        val adapter = ArrayAdapter<Contact>(
            this,
            android.R.layout.simple_list_item_1, // Use a built-in layout for simplicity
            contacts
        )
